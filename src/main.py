...
if __name__ == '__main__':
    ...
    bittorrent_epilog  = 'Report bugs to : <https://github.com/KhushiramMeena/file-share/issues>\n'
    bittorrent_epilog += 'Contribute open source : <https://github.com/KhushiramMeena/file-share>'
